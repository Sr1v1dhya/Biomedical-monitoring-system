#include <WiFi.h> //enable the wifi connection with the esp32
#include <WebServer.h> // is an essential part of creating web servers
#include <Wire.h> // The WebServer.h library is an essential part of creating web servers
#include "MAX30100_PulseOximeter.h" // to access functions of pulse oximeter
#include <OneWire.h> //  For body temperature sensor (DS18B20) 
...
html += "</div>";
if (BPM > 60) {
html += "<p id='more_beat' style='color:red;font-size:24px;font-weight:800' align='center'><i class='fas fa-triangle-exclamation'></i>The heart beat is more than 60 BPM!</p>";
}
html += "</div>";
html += "</body>";
html += "</html>";
